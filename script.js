...
const sommaAnon = function (num1, num2) {
    return num1 + num2
}
...
const sottrazione2 = (num1, num2) => (num1 - num2)
const divisione2 = (num1, num2) => (num1 / num2)
const moltiplicazione2 = (num1, num2) => (num1 * num2)
const operazioni = [somma2, sottrazione2, divisione2, moltiplicazione2]
